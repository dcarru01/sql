...
/* For simplicity I will use the * instead of all the column names going forward. */
...
SELECT v.vendor_id, vendor_name, vendor_type, vendor_owner_first_name, vendor_owner_last_name
,vba.vendor_id, booth_number, market_date
...
SELECT vendor_id, count (booth_number) as num_assignments
...
-- Date (I know this was waived but wanted to give it a try!)
...
FROM customer_purchases
WHERE market_month='04' and market_year='2022'
